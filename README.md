...
This code can be used as a basis for a project where we want to develop an application similar to a
social network
...
- Step 3: Set up your development environment After forking the repository, you need to configure
  ...
  the [README.md](https://github.com/PrinceLeBon/instagram_ui/blob/main/README.md) file for
